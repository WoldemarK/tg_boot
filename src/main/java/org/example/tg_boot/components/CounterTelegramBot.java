...
import org.example.tg_boot.repository.UserRepository;
...
public class CounterTelegramBot extends TelegramLongPollingBot implements BotCommands {
    ...
    public CounterTelegramBot(BotConfig config, UserRepository userRepo) {
        this.config = config;
        this.userRepo = userRepo;
        try {
            this.execute(new SetMyCommands(LIST_OF_COMMANDS,
    ...
    private void updateDB(long userId, String userName) {
        if(userRepo.findById(userId).isEmpty()){
            ...
            userRepo.updateMsgNumberByUserId(userId);
        }
    }
}
